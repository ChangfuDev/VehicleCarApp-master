...
public class LevelLoadingRenderer extends LoadingRenderer {
    ...
    private static final float DEFAULT_CENTER_RADIUS = 20f; //中心半径
    private static final float DEFAULT_STROKE_WIDTH = 2.5f; //粗径

    private static final int[] DEFAULT_LEVEL_COLORS = new int[]{Color.parseColor("#FF8C00"),
            Color.parseColor("#87CEFA"),Color.parseColor("#FA8072")};
